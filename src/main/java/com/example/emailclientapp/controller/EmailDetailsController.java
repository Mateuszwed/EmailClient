...
import com.example.emailclientapp.controller.services.MessageRendererService;
import com.example.emailclientapp.model.EmailMessage;
...
public class EmailDetailsController extends BaseController implements Initializable {
    ...
    private String LOCATION_OF_DOWNLOADS = System.getProperty("user.home") + "\\Download emails\\";
    ...
    private class AttachmentButton extends Button {
        ...
        public AttachmentButton(MimeBodyPart mimeBodyPart) throws MessagingException {
            ...
            this.setOnAction(e -> downloadedAttachment());
        }
